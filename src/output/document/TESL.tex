...
%
\isamarkupcancel{\ \ {\isacharbar}\ {\isasymopen}is{\isacharunderscore}public{\isacharunderscore}atom\ {\isacharparenleft}{\isacharunderscore}\ time{\isacharminus}delayed{\isasymsharp}\ by\ {\isacharunderscore}\ on\ {\isacharunderscore}\ implies\ {\isacharunderscore}{\isacharparenright}\ {\isacharequal}\ False{\isasymclose}}\isanewline
